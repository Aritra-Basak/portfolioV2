...
export default function Project({
    ...
    return (
        ...
        >
           <Link href={link}>
                <section className="bg-gray-100 max-w-[44rem] border border-black/5 rounded-lg m-b-8 overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
